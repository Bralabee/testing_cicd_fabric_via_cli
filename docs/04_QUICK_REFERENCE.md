...
| `CLI_REPO_REF` | `v1.8.0` | CLI Git tag or branch to install |
...
### Scaffold Config from an Existing Workspace (v1.8.0+)
...
2. Update fallback versions in workflow files (search for `v1.8.0` in `.github/workflows/`)
